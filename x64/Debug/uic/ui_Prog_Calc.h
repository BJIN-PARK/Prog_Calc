...
public:
    ...
    QPushButton *E_btn;
    QPushButton *F_btn;
    QPushButton *Paren_Right_btn;
    QPushButton *Percent_btn;
    QPushButton *Paren_Left_btn;
    ...
    void setupUi(QMainWindow *Prog_Calc)
    {
        ...
        Paren_Right_btn = new QPushButton(centralWidget);
        Paren_Right_btn->setObjectName(QStringLiteral("Paren_Right_btn"));
        Paren_Right_btn->setGeometry(QRect(150, 240, 70, 28));
        ...
        Paren_Left_btn = new QPushButton(centralWidget);
        Paren_Left_btn->setObjectName(QStringLiteral("Paren_Left_btn"));
        Paren_Left_btn->setGeometry(QRect(80, 240, 70, 28));
    ...
    void retranslateUi(QMainWindow *Prog_Calc)
    {
        ...
        Paren_Right_btn->setText(QApplication::translate("Prog_Calc", ")", nullptr));
        Percent_btn->setText(QApplication::translate("Prog_Calc", "\357\274\205", nullptr));
        Paren_Left_btn->setText(QApplication::translate("Prog_Calc", "(", nullptr));
